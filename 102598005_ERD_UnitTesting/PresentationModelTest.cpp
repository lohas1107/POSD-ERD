...
{
	_presentation._erModel->clearComponent();
	_presentation._erModel->initialize();
...
TEST_F(PresentationModelTest, canUndo)
{
	...
	_presentation._commandManager.clearCommandStack(_presentation._commandManager._undoCommands);
